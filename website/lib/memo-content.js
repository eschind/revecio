      ...
      sections: [
        {
          num: '01',
          label: 'The market',
          body: `<p>Outsourced CIO (OCIO) and investment consulting services manage and advise on <strong>$3.3T and $37T</strong> of institutional capital respectively — generating a combined <strong>$16.55B in annual revenue</strong>. The U.S. accounts for ~75% of OCIO AUM and is growing 16% per year; the OCIO market alone is projected to reach $4.4T by 2030. Most of this market is served by an analyst-heavy, spreadsheet-based model that has not structurally changed since the 1980s.</p>`,
          stats: [
            ['$2.5T', 'U.S. OCIO AUM today (16% YoY); $4.4T projected by 2030'],
            ['$16.55B', 'annual revenue across OCIO + investment consulting'],
            ['$1.25T', 'in 20–25k institutional pools $10M–$250M — structurally underserved'],
          ],
        },
        {
          num: '02',
          ...
          body: `<ul>
            ...
            <li><strong>Premium pricing.</strong> Blended rates for sub-$250M clients typically run 30–35 bps; fully loaded fees (incl. manager costs) can reach 75–175 bps — consuming budget that would otherwise fund mission.</li>
      ...
      sections: [
        {
          ...
          callout: {
            ...
            <p>OCIO is also <strong>harder than legal or accounting AI</strong> — more degrees of freedom, fewer clean right answers. That difficulty is the moat. Combined with long-term, trust-based client relationships and high switching costs, the resulting business is more defensible and far stickier than its AI-services peers.</p>`,
          },
        },
        {
          num: '05',
          ...
          pillars: [
            ['Initial wedge: the underserved segment', `Community foundations, education endowments, and arts/cultural organizations $10M–$250M. <strong>Radically transparent 15 bps pricing</strong> — half the market rate — with the fee schedule published on our website.`],
            ...
            ['Upmarket expansion', `From the underserved wedge into &gt;$250M institutions, hospitals, and pensions; eventually international markets.`],
            ['Software licensing', `License the agentic platform to large endowments, sovereign funds, and pensions that keep investing in-house. Multi-million-dollar contracts; defensible against horizontal AI labs via domain depth and proprietary outcome data.`],
          ],
        },
        {
          num: '06',
          label: 'Team',
          body: `<p>[Founder name] — [prior role/firm; investing or operating credibility]. [Co-founder/early hire — credentials]. Advisory board includes [advisor names — institutional investing, AI/ML, nonprofit governance].</p>`,
        },
      ],
      closing: {
        line: `We're building the investment platform institutions deserve.`,
        contact: `<strong>hello@revecio.com</strong> &nbsp;·&nbsp; revecio.com`,
      },
    },
  ],
};
